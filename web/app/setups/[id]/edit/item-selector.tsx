...
const RANGED_ITEMS = [
  ...
  11959, 21000, 27610, 11212, 21944, 26374,
];
const MAGIC_ITEMS = [
  21018, 21021, 21024, 19544, 13235, 21791, 12002, 28313, 26241, 26243, 26245,
  21006, 24424, 28266, 22323, 27275, 27251,
];
...
const RUNE_ITEMS = [
  ...
  4695, 4696, 4697, 4698, 4699, 28929,
];
