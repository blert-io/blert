...
const COLUMN_GROUPS: ColumnGroup[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      Column.COLOSSEUM_WAVE_3_ENTRY,
      Column.COLOSSEUM_WAVE_3,
      Column.COLOSSEUM_WAVE_4_ENTRY,
      Column.COLOSSEUM_WAVE_4,
      Column.COLOSSEUM_WAVE_5_ENTRY,
      Column.COLOSSEUM_WAVE_5,
      Column.COLOSSEUM_WAVE_6_ENTRY,
      Column.COLOSSEUM_WAVE_6,
      Column.COLOSSEUM_WAVE_7_ENTRY,
      Column.COLOSSEUM_WAVE_7,
      Column.COLOSSEUM_WAVE_8_ENTRY,
      Column.COLOSSEUM_WAVE_8,
      Column.COLOSSEUM_WAVE_9_ENTRY,
      Column.COLOSSEUM_WAVE_9,
      Column.COLOSSEUM_WAVE_10_ENTRY,
      Column.COLOSSEUM_WAVE_10,
      Column.COLOSSEUM_WAVE_11_ENTRY,
      Column.COLOSSEUM_WAVE_11,
      Column.COLOSSEUM_WAVE_12_ENTRY,
  ...
  },
  {
    ...
    columns: [
      ...
      Column.MOKHAIOTL_DELVE_3_ENTRY,
      Column.MOKHAIOTL_DELVE_3,
      Column.MOKHAIOTL_DELVE_4_ENTRY,
      Column.MOKHAIOTL_DELVE_4,
      Column.MOKHAIOTL_DELVE_5_ENTRY,
      Column.MOKHAIOTL_DELVE_5,
      Column.MOKHAIOTL_DELVE_6_ENTRY,
      Column.MOKHAIOTL_DELVE_6,
      Column.MOKHAIOTL_DELVE_7_ENTRY,
      Column.MOKHAIOTL_DELVE_7,
      Column.MOKHAIOTL_DELVE_8_ENTRY,
...
const COLUMNS: Record<Column, ColumnInfo> = {
  ...
  [Column.NYLOCAS_ENTRY]: splitColumn(
    'Nylo entry',
    SplitType.TOB_NYLO_START,
    120,
    'Nylocas entry',
  ),
  [Column.SOTETSEG_ENTRY]: splitColumn(
    'Sote entry',
    SplitType.TOB_SOTETSEG_START,
    120,
    'Sotetseg entry',
  ),
  [Column.XARPUS_ENTRY]: splitColumn(
    'Xarpus entry',
    SplitType.TOB_XARPUS_START,
    120,
    'Xarpus entry',
  ),
  [Column.VERZIK_ENTRY]: splitColumn(
    'Verzik entry',
    SplitType.TOB_VERZIK_START,
    120,
    'Verzik entry',
  ),
  [Column.COLOSSEUM_WAVE_3_ENTRY]: splitColumn(
    'Wave 3 entry',
    SplitType.COLOSSEUM_WAVE_3_START,
    130,
  ),
  [Column.COLOSSEUM_WAVE_4_ENTRY]: splitColumn(
    'Wave 4 entry',
    SplitType.COLOSSEUM_WAVE_4_START,
    130,
  ),
  [Column.COLOSSEUM_WAVE_5_ENTRY]: splitColumn(
    'Wave 5 entry',
    SplitType.COLOSSEUM_WAVE_5_START,
    130,
  ),
  [Column.COLOSSEUM_WAVE_6_ENTRY]: splitColumn(
    'Wave 6 entry',
    SplitType.COLOSSEUM_WAVE_6_START,
    130,
  ),
  [Column.COLOSSEUM_WAVE_7_ENTRY]: splitColumn(
    'Wave 7 entry',
    SplitType.COLOSSEUM_WAVE_7_START,
    130,
  ),
  [Column.COLOSSEUM_WAVE_8_ENTRY]: splitColumn(
    'Wave 8 entry',
    SplitType.COLOSSEUM_WAVE_8_START,
    130,
  ),
  [Column.COLOSSEUM_WAVE_9_ENTRY]: splitColumn(
    'Wave 9 entry',
    SplitType.COLOSSEUM_WAVE_9_START,
    130,
  ),
  [Column.COLOSSEUM_WAVE_10_ENTRY]: splitColumn(
    'Wave 10 entry',
    SplitType.COLOSSEUM_WAVE_10_START,
    140,
  ),
  [Column.COLOSSEUM_WAVE_11_ENTRY]: splitColumn(
    'Wave 11 entry',
    SplitType.COLOSSEUM_WAVE_11_START,
    140,
  ),
  [Column.COLOSSEUM_WAVE_12_ENTRY]: splitColumn(
    'Sol Heredit entry',
    SplitType.COLOSSEUM_WAVE_12_START,
    160,
  ),
  [Column.MOKHAIOTL_DELVE_3_ENTRY]: splitColumn(
    'Delve 3 entry',
    SplitType.MOKHAIOTL_DELVE_3_START,
    130,
  ),
  [Column.MOKHAIOTL_DELVE_4_ENTRY]: splitColumn(
    'Delve 4 entry',
    SplitType.MOKHAIOTL_DELVE_4_START,
    130,
  ),
  [Column.MOKHAIOTL_DELVE_5_ENTRY]: splitColumn(
    'Delve 5 entry',
    SplitType.MOKHAIOTL_DELVE_5_START,
    130,
  ),
  [Column.MOKHAIOTL_DELVE_6_ENTRY]: splitColumn(
    'Delve 6 entry',
    SplitType.MOKHAIOTL_DELVE_6_START,
    130,
  ),
  [Column.MOKHAIOTL_DELVE_7_ENTRY]: splitColumn(
    'Delve 7 entry',
    SplitType.MOKHAIOTL_DELVE_7_START,
    130,
  ),
  [Column.MOKHAIOTL_DELVE_8_ENTRY]: splitColumn(
    'Delve 8 entry',
    SplitType.MOKHAIOTL_DELVE_8_START,
    130,
  ),
};
